...
# User inputs
inputs = user_inputs()
update_controller_config("supertrend_v1", inputs)
...
st.write("---")
_config = get_controller_config("supertrend_v1")
render_save_config(_config["id"], _config, controller_name="supertrend_v1")
