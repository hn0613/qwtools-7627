...
from frontend.components.config_defaults import SUPERTREND_LENGTH, SUPERTREND_MULTIPLIER, SUPERTREND_PERCENTAGE_THRESHOLD
...
def user_inputs(controller_name: str = "supertrend_v1"):
    ...
    length = default_config.get("length", SUPERTREND_LENGTH)
    multiplier = default_config.get("multiplier", SUPERTREND_MULTIPLIER)
    percentage_threshold = default_config.get("percentage_threshold", SUPERTREND_PERCENTAGE_THRESHOLD)
